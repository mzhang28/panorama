...
RecentNodeStore::RecentNodeStore() {
  ...
  //   connect(js, &JournalStore::contentChanged, this,
  //           [this, js](const QString &nodeId, const QString &content) {
  ...
  //   connect(js, &JournalStore::titleChanged, this,
  //           [this, js](const QString &nodeId, const QString &title) {
  //             // find existing entry and update its title, or add a new one
  //             with
  //             // empty snippet
...
void RecentNodeStore::addOrUpdate(const QString &nodeId, const QString &title,
