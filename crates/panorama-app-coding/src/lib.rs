    ...
    fn heartbeat_schema() -> Schema {
        Schema {
            ...
            fields: vec![
                ...
                schema_field("entity", "coding", true, "File path, domain, or app identifier"),
                schema_field("type", "coding", true, "Entity type: file, app, url, or domain"),
                schema_field("category", "coding", false, "Activity category (coding, building, debugging, etc.)"),
                schema_field("time", "coding", true, "UNIX epoch timestamp with fractional seconds"),
                schema_field("project", "coding", false, "Project name"),
                schema_field("project_root_count", "coding", false, "Number of folders in project root path"),
                schema_field("branch", "coding", false, "Git branch name"),
                schema_field("language", "coding", false, "Programming language name"),
                schema_field("dependencies", "coding", false, "Comma-separated dependency list"),
                schema_field("machine_name_id", "coding", false, "Unique machine identifier"),
                // ── AI / GenAI fields ──────────────────────────────────
                schema_field("ai_line_changes", "coding", false, "Lines added/removed by GenAI since last heartbeat"),
                schema_field("human_line_changes", "coding", false, "Lines added/removed by manual typing since last heartbeat"),
                schema_field("ai_session", "coding", false, "AI session identifier"),
                schema_field("ai_input_tokens", "coding", false, "User input tokens consumed since last heartbeat"),
                schema_field("ai_output_tokens", "coding", false, "Model output tokens consumed since last heartbeat"),
                schema_field("ai_prompt_length", "coding", false, "Prompt characters typed to AI since last heartbeat"),
                schema_field("ai_subscription_plan", "coding", false, "GenAI tool subscription plan tier"),
                // ── Editor position fields ─────────────────────────────
                schema_field("lines", "coding", false, "Total lines in the entity file"),
                schema_field("lineno", "coding", false, "Current cursor line number (1-based)"),
                schema_field("cursorpos", "coding", false, "Current cursor column position (1-based)"),
                schema_field("is_write", "coding", false, "Whether this heartbeat was triggered by a write"),
                // ── Computed fields (set by this plugin, not submitted by clients) ─
                schema_field("duration", "coding", false, "Duration in seconds since previous heartbeat"),
                schema_field("is_ai_generated", "coding", false, "Whether this heartbeat involved AI code generation"),
            ],
    ...
    fn duration_schema() -> Schema {
        Schema {
            ...
            fields: vec![
                ...
                schema_field("duration_seconds", "coding", true, "Total duration in seconds"),
                schema_field("heartbeat_count", "coding", false, "Number of heartbeats in this session"),
                schema_field("machine_name_id", "coding", false, "Machine that produced this session"),
            ],
            schema_mode: SchemaMode::Preferred,
            previous_versions: vec![],
            migrations: vec![],
    ...
    fn daily_summary_schema() -> Schema {
        Schema {
            ...
            fields: vec![
                ...
                schema_field("category", "coding", false, "Activity category"),
                schema_field("total_seconds", "coding", true, "Total coding seconds for this dimension"),
                schema_field("heartbeat_count", "coding", false, "Number of heartbeats"),
                schema_field("session_count", "coding", false, "Number of coding sessions"),
                schema_field("ai_seconds", "coding", false, "Seconds involving AI-generated code"),
                schema_field("lines_added", "coding", false, "Total human lines added"),
                schema_field("lines_removed", "coding", false, "Total human lines removed"),
            ],
            schema_mode: SchemaMode::Preferred,
            previous_versions: vec![],
            migrations: vec![],
