...
export default function BeliApp({ pluginId }: BeliAppProps) {
  ...
  const tierColors = [
    '#6cff8c', '#8cc8ff', '#ffcc6c', '#ff8c8c',
    '#cc8cff', '#8cffcc', '#ffcc8c',
  ]
  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto' }}>
      ...
      >
        <select
          value={betterId}
          onChange={(e) => setBetterId(e.target.value)}
        >
        ...
        <select
          value={worseId}
          onChange={(e) => setWorseId(e.target.value)}
        >
      ...
      {loading ? (
        ...
        <div>
          <p className="text-muted" style={{ marginBottom: 12 }}>
            ...
            {rankings.total_comparisons} comparisons ·{' '}
            {rankings.tiers.length} tiers
          </p>
