          ...
          items: [
            {
              ...
              slug: "developer/core/architecture",
            },
            {
              label: "Reactor & Hook Subsystem",
              slug: "developer/core/reactor-system",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              slug: "developer/apps/getting-started",
            },
            {
              label: "Plugin API Reference",
              slug: "developer/apps/plugin-api",
            },
            {
              label: "Building & Packaging",
              slug: "developer/apps/building-packaging",
            },
            {
              label: "Example Reference Implementations",
              slug: "developer/apps/examples",
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              label: "Execution & Compiler Engine",
              slug: "pql/execution-engine",
            },
          ],
        },
      ],
